...
config.$inject = ['$stateProvider', '$urlRouterProvider', '$resourceProvider', 'cfpLoadingBarProvider', '$compileProvider'];

function config($stateProvider, $urlRouterProvider, $resourceProvider, cfpLoadingBarProvider, $compileProvider) {
    ...
    $stateProvider
        ...
        .state('occupancy.getPassword', {
            url: '/getPassword',
            templateUrl: './src/occupancy/getPassword/getPassword.html',
            controller: 'GetPasswordController as vm',
            custom: {
                data: '获取密码'
            }
        })
